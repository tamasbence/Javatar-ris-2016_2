...
public class SafetyLogicLocalDecisionTest {
	...
	public void testNoDisabledSectionSwitching() {
		...
		inOrderSignalMapper.verify(signalMapper, times(7))
	...
	public void testOccupiedSectionsLinkage() {
		...
		inOrderSignalMapper.verify(signalMapper)
				.sendControl(eq(SideTriple.of(SectionControl.DISABLED, SectionControl.ENABLED, SectionControl.ENABLED)
						.with(occupiedSide, SectionControl.DISABLED)));
		inOrderSignalMapper.verify(signalMapper)
				.sendControl(eq(initialSectionControls.with(occupiedSide, SectionControl.DISABLED)));
